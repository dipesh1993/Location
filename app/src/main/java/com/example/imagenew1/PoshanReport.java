...
public class PoshanReport extends Fragment {
    View view;
    String user_id;
    ListView simpleList;
    List<Reporter> reportList;
    private static final String URL_PRODUCTS = "http://hotel.intellecttechnosoft.com/project/poshanreport.php";
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                reportList.add(new Reporter(
                                        ...
                                        report.getString("school_name"),
                                        report.getString("place")
                                ));
                            }
